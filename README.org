...
- Using optima will result in code that is looks much more maintainable http://enthusiasm.cozy.org/archives/2013/07/optima https://github.com/bhyde/backward-parenscript/blob/master/main.lisp#L70
